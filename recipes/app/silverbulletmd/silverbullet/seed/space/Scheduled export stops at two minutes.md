...
* [[Run the 50k-row export test]] — Lucas Meyer, done
* [[Run the 75k-row export test]] — Lucas Meyer, done
* [[Remove the partial object after cancellation]] — Lucas Meyer, blocked
